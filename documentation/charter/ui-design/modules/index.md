...
- **Dev mode**: Replaced by quick-login card grid; each card shows avatar, name, email, role badge, tenant tag. Clicking a card triggers auto-login (see [User & Role Management spec](/charter/specs/modules/user-role-management/index.md#dev-mode-quick-login))
